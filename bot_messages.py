start_command_response =  "Привет 👋🏼, меня зовут Graddy!" \
                          "\n" \
                          "\n" \
                          "Я буду оповещать тебя о новых оценках и считать твой GPA😋\n" \
                          "\n" \
...
help_command_response = "Доступные команды:" \
                        ...
                        "\n" \
                        "4. /my_grades - все оценки" \
                        "\n" \
                        "5. /GPA - посчитать свой GPA" \
                        "\n" \
...
wrong_login_response = 'Введенный логин не соответсвует формату. Попробуй ввести логин еще раз.'

successful_moodle_login_response = 'Замечательно! Теперь я буду уведомлять тебя о новых оценках!'

set_username_response = 'Хорошо, приятель, какой у тебя логин для входа в <b>moodle</b>? \n\nВведи /cancel, если вызвал команду по ошибке.'

set_password_response = 'Введи пароль, который ты используешь для входа в <b>moodle</b>. Все пароли надежно шифруются, поэтому можешь не беспокоится за их сохранность.\n\nВведи /cancel, если вызвал команду по ошибке.'

feedback_command_response = 'Напишите Ваш отзыв, мы обязательно его прочтем 👻\n\nПропишите /cancel, если вызвали команду по ошибке.'

disable_notifying_minutes_response = 'Больше не буду уведмолять тебя 🙂'
